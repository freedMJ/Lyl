...
from . import views
from orders.views import IndexView,ResultView,Result_usertokenView,Result_ordernoView,Is_filledView,LoginView,TestViews,ResultAjax
...
urlpatterns = [
    ...
    url(r"^test$",TestViews.as_view()),
    url(r"^result_ajax$",ResultAjax.as_view()),
    #url(r"^result_ajax(?P<pindex>\d*)",views.result_ajax),
